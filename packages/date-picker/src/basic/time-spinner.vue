...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'gcj-element-ui/src/utils/date-util';
  import ElScrollbar from 'gcj-element-ui/packages/scrollbar';
  import RepeatClick from 'gcj-element-ui/src/directives/repeat-click';
